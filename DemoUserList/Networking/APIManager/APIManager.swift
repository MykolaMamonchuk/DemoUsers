...
final class APIManager {
    ...
    func getUsers(completion: @escaping Response<[UserML]>) {
        let router = UserRouter(anEndpoint: .getUsers)
    ...
    func getUsersPosts(completion: @escaping Response<[PostML]>) {
        let router = PostRouter(anEndpoint: .getUsersPosts)
        performRequest(router: router, completion: completion)
    }
}
